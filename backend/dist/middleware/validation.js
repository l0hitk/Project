...
exports.validateMyUserRequest = [
    ...
    (0, express_validator_1.body)("institute").isString().notEmpty().withMessage("Institute name must be a string"),
    (0, express_validator_1.body)("city").isString().notEmpty().withMessage("city must be a string"),
    (0, express_validator_1.body)("branch").isString().notEmpty().withMessage("Branch must be a string"),
